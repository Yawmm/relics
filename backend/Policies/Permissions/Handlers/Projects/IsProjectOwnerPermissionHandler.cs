...
public class IsProjectOwnerPermissionHandler : IPermissionHandler<IsProjectOwnerPermission>
{
    private readonly IProjectService _projectService;

    public IsProjectOwnerPermissionHandler(IProjectService projectService)
    {
        _projectService = projectService;
    }

    /// <inheritdoc cref="IPermissionHandler{T}.Handle"/>
    public void Handle(IsProjectOwnerPermission permission, IMiddlewareContext middleware, AuthorizationHandlerContext context)
    {
