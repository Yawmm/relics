...
public class IsTeamMemberPermissionHandler : IPermissionHandler<IsTeamMemberPermission>
{
    private readonly ITeamService _teamService;
    
    public IsTeamMemberPermissionHandler(ITeamService teamService)
    {
        _teamService = teamService;
    }
    
    /// <inheritdoc cref="IPermissionHandler{T}.Handle"/>
    public void Handle(IsTeamMemberPermission permission, IMiddlewareContext middleware, AuthorizationHandlerContext context)
    {
