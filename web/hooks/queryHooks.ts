...
import {GET_PROJECT_QUERY, GET_PROJECTS_QUERY} from "@/lib/projects";
...
export const useProjectsQuery = (user : User | null) => useQuery<{ projects: Project[] }>(GET_PROJECTS_QUERY, {
	variables: {
		userId: user?.id
	},
	skip: user === null,
...
export const useProjectQuery = (id: string) => useQuery<{ project: Project }>(GET_PROJECT_QUERY, {
	variables: {
		id: id
	},
	skip: id === null,
